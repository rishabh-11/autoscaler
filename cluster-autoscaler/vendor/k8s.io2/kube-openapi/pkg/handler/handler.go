...
import (
	...
	"github.com2/NYTimes/gziphandler"
	restful "github.com2/emicklei/go-restful"
	"github.com2/go-openapi/spec"
	"github.com2/golang/protobuf/proto"
	openapi_v2 "github.com2/googleapis/gnostic/OpenAPIv2"
	"github.com2/googleapis/gnostic/compiler"

	"k8s.io2/kube-openapi/pkg/builder"
	"k8s.io2/kube-openapi/pkg/common"
)
