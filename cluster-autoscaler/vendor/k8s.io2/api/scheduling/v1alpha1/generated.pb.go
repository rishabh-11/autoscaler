...
func init() {
	proto.RegisterType((*PriorityClass)(nil), "k8s.io2.api.scheduling.v1alpha1.PriorityClass")
	proto.RegisterType((*PriorityClassList)(nil), "k8s.io2.api.scheduling.v1alpha1.PriorityClassList")
}
...
func init() {
	proto.RegisterFile("k8s.io2/kubernetes/vendor/k8s.io/api/scheduling/v1alpha1/generated.proto", fileDescriptorGenerated)
}
