...
func init() {
	proto.RegisterType((*StorageClass)(nil), "k8s.io2.api.storage.v1beta1.StorageClass")
	proto.RegisterType((*StorageClassList)(nil), "k8s.io2.api.storage.v1beta1.StorageClassList")
}
...
func init() {
	proto.RegisterFile("k8s.io2/kubernetes/vendor/k8s.io/api/storage/v1beta1/generated.proto", fileDescriptorGenerated)
}
