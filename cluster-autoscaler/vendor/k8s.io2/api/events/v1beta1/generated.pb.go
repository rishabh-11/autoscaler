...
func init() {
	proto.RegisterType((*Event)(nil), "k8s.io2.api.events.v1beta1.Event")
	proto.RegisterType((*EventList)(nil), "k8s.io2.api.events.v1beta1.EventList")
	proto.RegisterType((*EventSeries)(nil), "k8s.io2.api.events.v1beta1.EventSeries")
}
...
func (this *Event) String() string {
	...
	s := strings.Join([]string{`&Event{`,
		...
		`EventTime:` + strings.Replace(strings.Replace(this.EventTime.String(), "MicroTime", "k8s.io2_apimachinery_pkg_apis_meta_v1.MicroTime", 1), `&`, ``, 1) + `,`,
		...
		`Regarding:` + strings.Replace(strings.Replace(this.Regarding.String(), "ObjectReference", "k8s.io2_api_core_v1.ObjectReference", 1), `&`, ``, 1) + `,`,
		`Related:` + strings.Replace(fmt.Sprintf("%v", this.Related), "ObjectReference", "k8s.io2_api_core_v1.ObjectReference", 1) + `,`,
		`Note:` + fmt.Sprintf("%v", this.Note) + `,`,
		`Type:` + fmt.Sprintf("%v", this.Type) + `,`,
		`DeprecatedSource:` + strings.Replace(strings.Replace(this.DeprecatedSource.String(), "EventSource", "k8s.io2_api_core_v1.EventSource", 1), `&`, ``, 1) + `,`,
		`DeprecatedFirstTimestamp:` + strings.Replace(strings.Replace(this.DeprecatedFirstTimestamp.String(), "Time", "k8s.io2_apimachinery_pkg_apis_meta_v1.Time", 1), `&`, ``, 1) + `,`,
		`DeprecatedLastTimestamp:` + strings.Replace(strings.Replace(this.DeprecatedLastTimestamp.String(), "Time", "k8s.io2_apimachinery_pkg_apis_meta_v1.Time", 1), `&`, ``, 1) + `,`,
...
func (this *EventSeries) String() string {
	...
	s := strings.Join([]string{`&EventSeries{`,
		...
		`LastObservedTime:` + strings.Replace(strings.Replace(this.LastObservedTime.String(), "MicroTime", "k8s.io2_apimachinery_pkg_apis_meta_v1.MicroTime", 1), `&`, ``, 1) + `,`,
...
func init() {
	proto.RegisterFile("k8s.io2/kubernetes/vendor/k8s.io/api/events/v1beta1/generated.proto", fileDescriptorGenerated)
}
