...
func init() {
	proto.RegisterType((*Eviction)(nil), "k8s.io2.api.policy.v1beta1.Eviction")
	proto.RegisterType((*PodDisruptionBudget)(nil), "k8s.io2.api.policy.v1beta1.PodDisruptionBudget")
	proto.RegisterType((*PodDisruptionBudgetList)(nil), "k8s.io2.api.policy.v1beta1.PodDisruptionBudgetList")
	proto.RegisterType((*PodDisruptionBudgetSpec)(nil), "k8s.io2.api.policy.v1beta1.PodDisruptionBudgetSpec")
	proto.RegisterType((*PodDisruptionBudgetStatus)(nil), "k8s.io2.api.policy.v1beta1.PodDisruptionBudgetStatus")
}
...
func (this *Eviction) String() string {
	...
	s := strings.Join([]string{`&Eviction{`,
		...
		`DeleteOptions:` + strings.Replace(fmt.Sprintf("%v", this.DeleteOptions), "DeleteOptions", "k8s.io2_apimachinery_pkg_apis_meta_v1.DeleteOptions", 1) + `,`,
		`}`,
	}, "")
	return s
}
...
func (this *PodDisruptionBudgetSpec) String() string {
	...
	s := strings.Join([]string{`&PodDisruptionBudgetSpec{`,
		`MinAvailable:` + strings.Replace(fmt.Sprintf("%v", this.MinAvailable), "IntOrString", "k8s.io2_apimachinery_pkg_util_intstr.IntOrString", 1) + `,`,
...
func init() {
	proto.RegisterFile("k8s.io2/kubernetes/vendor/k8s.io/api/policy/v1beta1/generated.proto", fileDescriptorGenerated)
}
