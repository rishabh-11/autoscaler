...
func init() {
	proto.RegisterType((*ExtraValue)(nil), "k8s.io2.api.authentication.v1.ExtraValue")
	proto.RegisterType((*TokenReview)(nil), "k8s.io2.api.authentication.v1.TokenReview")
	proto.RegisterType((*TokenReviewSpec)(nil), "k8s.io2.api.authentication.v1.TokenReviewSpec")
	proto.RegisterType((*TokenReviewStatus)(nil), "k8s.io2.api.authentication.v1.TokenReviewStatus")
	proto.RegisterType((*UserInfo)(nil), "k8s.io2.api.authentication.v1.UserInfo")
}
...
func init() {
	proto.RegisterFile("k8s.io2/kubernetes/vendor/k8s.io/api/authentication/v1/generated.proto", fileDescriptorGenerated)
}
