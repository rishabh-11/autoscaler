...
func init() {
	proto.RegisterType((*MutatingWebhookConfiguration)(nil), "k8s.io2.api.admissionregistration.v1beta1.MutatingWebhookConfiguration")
	proto.RegisterType((*MutatingWebhookConfigurationList)(nil), "k8s.io2.api.admissionregistration.v1beta1.MutatingWebhookConfigurationList")
	proto.RegisterType((*Rule)(nil), "k8s.io2.api.admissionregistration.v1beta1.Rule")
	proto.RegisterType((*RuleWithOperations)(nil), "k8s.io2.api.admissionregistration.v1beta1.RuleWithOperations")
	proto.RegisterType((*ServiceReference)(nil), "k8s.io2.api.admissionregistration.v1beta1.ServiceReference")
	proto.RegisterType((*ValidatingWebhookConfiguration)(nil), "k8s.io2.api.admissionregistration.v1beta1.ValidatingWebhookConfiguration")
	proto.RegisterType((*ValidatingWebhookConfigurationList)(nil), "k8s.io2.api.admissionregistration.v1beta1.ValidatingWebhookConfigurationList")
	proto.RegisterType((*Webhook)(nil), "k8s.io2.api.admissionregistration.v1beta1.Webhook")
	proto.RegisterType((*WebhookClientConfig)(nil), "k8s.io2.api.admissionregistration.v1beta1.WebhookClientConfig")
}
...
func init() {
	proto.RegisterFile("k8s.io2/kubernetes/vendor/k8s.io/api/admissionregistration/v1beta1/generated.proto", fileDescriptorGenerated)
}
