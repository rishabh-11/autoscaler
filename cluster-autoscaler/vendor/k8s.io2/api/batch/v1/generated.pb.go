...
func init() {
	proto.RegisterType((*Job)(nil), "k8s.io2.api.batch.v1.Job")
	proto.RegisterType((*JobCondition)(nil), "k8s.io2.api.batch.v1.JobCondition")
	proto.RegisterType((*JobList)(nil), "k8s.io2.api.batch.v1.JobList")
	proto.RegisterType((*JobSpec)(nil), "k8s.io2.api.batch.v1.JobSpec")
	proto.RegisterType((*JobStatus)(nil), "k8s.io2.api.batch.v1.JobStatus")
}
...
func (this *JobCondition) String() string {
	...
	s := strings.Join([]string{`&JobCondition{`,
		...
		`LastProbeTime:` + strings.Replace(strings.Replace(this.LastProbeTime.String(), "Time", "k8s.io2_apimachinery_pkg_apis_meta_v1.Time", 1), `&`, ``, 1) + `,`,
...
func (this *JobStatus) String() string {
	...
	s := strings.Join([]string{`&JobStatus{`,
		...
		`StartTime:` + strings.Replace(fmt.Sprintf("%v", this.StartTime), "Time", "k8s.io2_apimachinery_pkg_apis_meta_v1.Time", 1) + `,`,
		`CompletionTime:` + strings.Replace(fmt.Sprintf("%v", this.CompletionTime), "Time", "k8s.io2_apimachinery_pkg_apis_meta_v1.Time", 1) + `,`,
...
func init() {
	proto.RegisterFile("k8s.io2/kubernetes/vendor/k8s.io/api/batch/v1/generated.proto", fileDescriptorGenerated)
}
