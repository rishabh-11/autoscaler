...
import (
	...
	jsonpatch "github.com2/evanphx/json-patch"
	"github.com2/golang/glog"

	admissionv1beta1 "k8s.io2/api/admission/v1beta1"
	"k8s.io2/api/admissionregistration/v1beta1"
	...
	"k8s.io2/apimachinery/pkg/runtime/serializer/json"
	utilruntime "k8s.io2/apimachinery/pkg/util/runtime"
	"k8s.io2/apimachinery/pkg/util/wait"
	"k8s.io2/apiserver/pkg/admission"
	"k8s.io2/apiserver/pkg/admission/configuration"
	genericadmissioninit "k8s.io2/apiserver/pkg/admission/initializer"
	admissionmetrics "k8s.io2/apiserver/pkg/admission/metrics"
	"k8s.io2/apiserver/pkg/admission/plugin/webhook/config"
	webhookerrors "k8s.io2/apiserver/pkg/admission/plugin/webhook/errors"
	"k8s.io2/apiserver/pkg/admission/plugin/webhook/namespace"
	"k8s.io2/apiserver/pkg/admission/plugin/webhook/request"
	"k8s.io2/apiserver/pkg/admission/plugin/webhook/rules"
	"k8s.io2/apiserver/pkg/admission/plugin/webhook/versioned"
