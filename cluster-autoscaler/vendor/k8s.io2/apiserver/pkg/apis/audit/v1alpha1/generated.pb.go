...
import k8s_io_api_authentication_v1 "k8s.io2/api/authentication/v1"
...
func init() {
	proto.RegisterType((*Event)(nil), "k8s.io2.apiserver.pkg.apis.audit.v1alpha1.Event")
	proto.RegisterType((*EventList)(nil), "k8s.io2.apiserver.pkg.apis.audit.v1alpha1.EventList")
	proto.RegisterType((*GroupResources)(nil), "k8s.io2.apiserver.pkg.apis.audit.v1alpha1.GroupResources")
	proto.RegisterType((*ObjectReference)(nil), "k8s.io2.apiserver.pkg.apis.audit.v1alpha1.ObjectReference")
	proto.RegisterType((*Policy)(nil), "k8s.io2.apiserver.pkg.apis.audit.v1alpha1.Policy")
	proto.RegisterType((*PolicyList)(nil), "k8s.io2.apiserver.pkg.apis.audit.v1alpha1.PolicyList")
	proto.RegisterType((*PolicyRule)(nil), "k8s.io2.apiserver.pkg.apis.audit.v1alpha1.PolicyRule")
}
...
func (this *Event) String() string {
	...
	s := strings.Join([]string{`&Event{`,
		...
		`Timestamp:` + strings.Replace(strings.Replace(this.Timestamp.String(), "Time", "k8s.io2_apimachinery_pkg_apis_meta_v1.Time", 1), `&`, ``, 1) + `,`,
		...
		`User:` + strings.Replace(strings.Replace(this.User.String(), "UserInfo", "k8s.io2_api_authentication_v1.UserInfo", 1), `&`, ``, 1) + `,`,
		`ImpersonatedUser:` + strings.Replace(fmt.Sprintf("%v", this.ImpersonatedUser), "UserInfo", "k8s.io2_api_authentication_v1.UserInfo", 1) + `,`,
		...
		`ResponseStatus:` + strings.Replace(fmt.Sprintf("%v", this.ResponseStatus), "Status", "k8s.io2_apimachinery_pkg_apis_meta_v1.Status", 1) + `,`,
		`RequestObject:` + strings.Replace(fmt.Sprintf("%v", this.RequestObject), "Unknown", "k8s.io2_apimachinery_pkg_runtime.Unknown", 1) + `,`,
		`ResponseObject:` + strings.Replace(fmt.Sprintf("%v", this.ResponseObject), "Unknown", "k8s.io2_apimachinery_pkg_runtime.Unknown", 1) + `,`,
		`RequestReceivedTimestamp:` + strings.Replace(strings.Replace(this.RequestReceivedTimestamp.String(), "MicroTime", "k8s.io2_apimachinery_pkg_apis_meta_v1.MicroTime", 1), `&`, ``, 1) + `,`,
		`StageTimestamp:` + strings.Replace(strings.Replace(this.StageTimestamp.String(), "MicroTime", "k8s.io2_apimachinery_pkg_apis_meta_v1.MicroTime", 1), `&`, ``, 1) + `,`,
		`}`,
	}, "")
	return s
}
...
func init() {
	proto.RegisterFile("k8s.io2/kubernetes/vendor/k8s.io/apiserver/pkg/apis/audit/v1alpha1/generated.proto", fileDescriptorGenerated)
}
