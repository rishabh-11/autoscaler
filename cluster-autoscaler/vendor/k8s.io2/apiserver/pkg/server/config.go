...
import (
	...
	"github.com2/emicklei/go-restful-swagger12"
	"github.com2/go-openapi/spec"
	"github.com2/pborman/uuid"

	"k8s.io2/apimachinery/pkg/runtime"
	"k8s.io2/apimachinery/pkg/runtime/serializer"
	"k8s.io2/apimachinery/pkg/util/sets"
	utilwaitgroup "k8s.io2/apimachinery/pkg/util/waitgroup"
	"k8s.io2/apimachinery/pkg/version"
	"k8s.io2/apiserver/pkg/admission"
	"k8s.io2/apiserver/pkg/audit"
	auditpolicy "k8s.io2/apiserver/pkg/audit/policy"
	"k8s.io2/apiserver/pkg/authentication/authenticator"
	"k8s.io2/apiserver/pkg/authentication/authenticatorfactory"
	authenticatorunion "k8s.io2/apiserver/pkg/authentication/request/union"
	"k8s.io2/apiserver/pkg/authentication/user"
	"k8s.io2/apiserver/pkg/authorization/authorizer"
	"k8s.io2/apiserver/pkg/authorization/authorizerfactory"
	authorizerunion "k8s.io2/apiserver/pkg/authorization/union"
	"k8s.io2/apiserver/pkg/endpoints/discovery"
	genericapifilters "k8s.io2/apiserver/pkg/endpoints/filters"
	apiopenapi "k8s.io2/apiserver/pkg/endpoints/openapi"
	apirequest "k8s.io2/apiserver/pkg/endpoints/request"
	"k8s.io2/apiserver/pkg/features"
	genericregistry "k8s.io2/apiserver/pkg/registry/generic"
	genericfilters "k8s.io2/apiserver/pkg/server/filters"
	"k8s.io2/apiserver/pkg/server/healthz"
	"k8s.io2/apiserver/pkg/server/routes"
	utilfeature "k8s.io2/apiserver/pkg/util/feature"
	"k8s.io2/client-go/informers"
	restclient "k8s.io2/client-go/rest"
	certutil "k8s.io2/client-go/util/cert"
	openapicommon "k8s.io2/kube-openapi/pkg/common"

	// install apis
	_ "k8s.io2/apiserver/pkg/apis/apiserver/install"
)
