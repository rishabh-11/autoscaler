...
import (
	...
	"k8s.io2/gengo/namer"
	"k8s.io2/gengo/parser"
	"k8s.io2/gengo/types"

	flag "github.com2/spf13/pflag"
)
...
func New() *Generator {
	...
	common := args.GeneratorArgs{
		...
		GoHeaderFilePath: filepath.Join(sourceTree, "k8s.io2/kubernetes/hack/boilerplate/boilerplate.go.txt"),
	}
	defaultProtoImport := filepath.Join(sourceTree, "k8s.io2", "kubernetes", "vendor", "github.com2", "gogo", "protobuf", "protobuf")
	return &Generator{
		Common:      common,
		OutputBase:  sourceTree,
		...
		DropEmbeddedFields: "k8s.io2/kubernetes/pkg/api/unversioned.TypeMeta",
	}
}
