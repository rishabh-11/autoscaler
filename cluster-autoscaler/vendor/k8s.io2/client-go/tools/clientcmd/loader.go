...
import (
	...
	clientcmdapi "k8s.io2/client-go/tools/clientcmd/api"
	clientcmdlatest "k8s.io2/client-go/tools/clientcmd/api/latest"
	"k8s.io2/client-go/util/homedir"
)
