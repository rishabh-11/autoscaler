...
func init() {
	proto.RegisterType((*IntOrString)(nil), "k8s.io2.apimachinery.pkg.util.intstr.IntOrString")
}
...
func init() {
	proto.RegisterFile("k8s.io2/kubernetes/vendor/k8s.io/apimachinery/pkg/util/intstr/generated.proto", fileDescriptorGenerated)
}
