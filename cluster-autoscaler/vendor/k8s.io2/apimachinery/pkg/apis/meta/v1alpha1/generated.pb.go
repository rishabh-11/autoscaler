...
func init() {
	proto.RegisterType((*PartialObjectMetadata)(nil), "k8s.io2.apimachinery.pkg.apis.meta.v1alpha1.PartialObjectMetadata")
	proto.RegisterType((*PartialObjectMetadataList)(nil), "k8s.io2.apimachinery.pkg.apis.meta.v1alpha1.PartialObjectMetadataList")
	proto.RegisterType((*TableOptions)(nil), "k8s.io2.apimachinery.pkg.apis.meta.v1alpha1.TableOptions")
}
...
func init() {
	proto.RegisterFile("k8s.io2/kubernetes/vendor/k8s.io/apimachinery/pkg/apis/meta/v1alpha1/generated.proto", fileDescriptorGenerated)
}
