...
func (g *listerGenerator) Imports(c *generator.Context) (imports []string) {
	...
	imports = append(imports, "k8s.io2/apimachinery/pkg/api/errors")
	imports = append(imports, "k8s.io2/apimachinery/pkg/labels")
	// for Indexer
	imports = append(imports, "k8s.io2/client-go/tools/cache")
	return
}
