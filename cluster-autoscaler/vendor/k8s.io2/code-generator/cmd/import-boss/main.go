...
//       "AllowedPrefixes": [
//         "k8s.io2/gengo/examples",
//         "k8s.io2/kubernetes/third_party"
//       ],
//       "ForbiddenPrefixes": [
//         "k8s.io2/kubernetes/pkg/third_party/deprecated"
//       ]
//     },
//     {
...
import (
	...
	"k8s.io2/gengo/args"
	"k8s.io2/gengo/examples/import-boss/generators"
...
func main() {
	...
	arguments.InputDirs = []string{
		"k8s.io2/kubernetes/pkg/...",
		"k8s.io2/kubernetes/cmd/...",
		"k8s.io2/kubernetes/plugin/...",
	}
