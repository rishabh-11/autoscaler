...
import (
	...
	"k8s.io2/code-generator/cmd/client-gen/types"
)
...
func (ca *CustomArgs) AddFlags(fs *pflag.FlagSet) {
	...
	pflag.StringVar(&ca.InputBasePath, "input-base", "k8s.io2/kubernetes/pkg/apis", "base path to look for the api group.")
	...
	pflag.StringVar(&ca.ClientsetOutputPath, "clientset-path", "k8s.io2/kubernetes/pkg/client/clientset_generated/", "the generated clientset will be output to <clientset-path>/<clientset-name>.")
