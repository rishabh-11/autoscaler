...
import (
	...
	clientgenargs "k8s.io2/code-generator/cmd/client-gen/args"
	"k8s.io2/code-generator/cmd/client-gen/generators/fake"
	"k8s.io2/code-generator/cmd/client-gen/generators/scheme"
...
func NameSystems() namer.NameSystems {
	...
	publicNamer := &ExceptionNamer{
		...
		// "k8s.io2/apis/events/v1beta1.Event": "EventResource"
		},
	...
	privatePluralNamer := &ExceptionNamer{
		Exceptions: map[string]string{
			...
			// "k8s.io2/apis/events/v1beta1.Event": "eventResource"
			// these exceptions are used to deconflict the generated code
			"k8s.io2/apis/events/v1beta1.Event":        "eventResources",
			"k8s.io2/kubernetes/pkg/apis/events.Event": "eventResources",
		},
		KeyFunc: func(t *types.Type) string {
			return t.Name.Package + "." + t.Name.Name
		},
