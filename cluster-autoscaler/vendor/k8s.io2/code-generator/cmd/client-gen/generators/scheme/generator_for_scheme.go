...
import (
	...
	"k8s.io2/code-generator/cmd/client-gen/path"
	clientgentypes "k8s.io2/code-generator/cmd/client-gen/types"
...
func (g *GenScheme) GenerateType(c *generator.Context, t *types.Type, w io.Writer) error {
	...
	m := map[string]interface{}{
		...
		"runtimeNewParameterCodec":         c.Universe.Function(types.Name{Package: "k8s.io2/apimachinery/pkg/runtime", Name: "NewParameterCodec"}),
		"runtimeNewScheme":                 c.Universe.Function(types.Name{Package: "k8s.io2/apimachinery/pkg/runtime", Name: "NewScheme"}),
		"serializerNewCodecFactory":        c.Universe.Function(types.Name{Package: "k8s.io2/apimachinery/pkg/runtime/serializer", Name: "NewCodecFactory"}),
		"runtimeScheme":                    c.Universe.Type(types.Name{Package: "k8s.io2/apimachinery/pkg/runtime", Name: "Scheme"}),
		"schemaGroupVersion":               c.Universe.Type(types.Name{Package: "k8s.io2/apimachinery/pkg/runtime/schema", Name: "GroupVersion"}),
		"metav1AddToGroupVersion":          c.Universe.Function(types.Name{Package: "k8s.io2/apimachinery/pkg/apis/meta/v1", Name: "AddToGroupVersion"}),
		"announcedAPIGroupFactoryRegistry": c.Universe.Type(types.Name{Package: "k8s.io2/apimachinery/pkg/apimachinery/announced", Name: "APIGroupFactoryRegistry"}),
		"registeredNewOrDie":               c.Universe.Function(types.Name{Package: "k8s.io2/apimachinery/pkg/apimachinery/registered", Name: "NewOrDie"}),
		"registeredAPIRegistrationManager": c.Universe.Type(types.Name{Package: "k8s.io2/apimachinery/pkg/apimachinery/registered", Name: "APIRegistrationManager"}),
	}
...
//     clientsetscheme "k8s.io2/client-go/kuberentes/scheme"
//     aggregatorclientsetscheme "k8s.io2/kube-aggregator/pkg/client/clientset_generated/clientset/scheme"
//   )
//
