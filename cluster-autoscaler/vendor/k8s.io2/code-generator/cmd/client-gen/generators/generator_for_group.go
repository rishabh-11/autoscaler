...
func (g *genGroup) GenerateType(c *generator.Context, t *types.Type, w io.Writer) error {
	...
	m := map[string]interface{}{
		...
		"runtimeAPIVersionInternal":      c.Universe.Variable(types.Name{Package: "k8s.io2/apimachinery/pkg/runtime", Name: "APIVersionInternal"}),
		"serializerDirectCodecFactory":   c.Universe.Type(types.Name{Package: "k8s.io2/apimachinery/pkg/runtime/serializer", Name: "DirectCodecFactory"}),
		"restConfig":                     c.Universe.Type(types.Name{Package: "k8s.io2/client-go/rest", Name: "Config"}),
		"restDefaultKubernetesUserAgent": c.Universe.Function(types.Name{Package: "k8s.io2/client-go/rest", Name: "DefaultKubernetesUserAgent"}),
		"restRESTClientInterface":        c.Universe.Type(types.Name{Package: "k8s.io2/client-go/rest", Name: "Interface"}),
		"restRESTClientFor":              c.Universe.Function(types.Name{Package: "k8s.io2/client-go/rest", Name: "RESTClientFor"}),
