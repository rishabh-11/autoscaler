...
import (
	...
	versioned "k8s.io2/code-generator/_examples/apiserver/clientset/versioned"
	example "k8s.io2/code-generator/_examples/apiserver/informers/externalversions/example"
	example2 "k8s.io2/code-generator/_examples/apiserver/informers/externalversions/example2"
	internalinterfaces "k8s.io2/code-generator/_examples/apiserver/informers/externalversions/internalinterfaces"
	reflect "reflect"
	sync "sync"
	time "time"
)
