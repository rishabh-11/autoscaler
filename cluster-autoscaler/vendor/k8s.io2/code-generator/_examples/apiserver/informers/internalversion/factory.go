...
import (
	...
	internalversion "k8s.io2/code-generator/_examples/apiserver/clientset/internalversion"
	example "k8s.io2/code-generator/_examples/apiserver/informers/internalversion/example"
	example2 "k8s.io2/code-generator/_examples/apiserver/informers/internalversion/example2"
	internalinterfaces "k8s.io2/code-generator/_examples/apiserver/informers/internalversion/internalinterfaces"
	reflect "reflect"
	sync "sync"
	time "time"
)
