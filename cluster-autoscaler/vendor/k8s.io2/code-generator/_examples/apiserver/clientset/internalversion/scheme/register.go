...
import (
	announced "k8s.io2/apimachinery/pkg/apimachinery/announced"
	registered "k8s.io2/apimachinery/pkg/apimachinery/registered"
	...
	example "k8s.io2/code-generator/_examples/apiserver/apis/example/install"
	secondexample "k8s.io2/code-generator/_examples/apiserver/apis/example2/install"
	os "os"
)
