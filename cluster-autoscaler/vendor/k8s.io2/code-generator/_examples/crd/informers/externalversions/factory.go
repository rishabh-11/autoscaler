...
import (
	...
	versioned "k8s.io2/code-generator/_examples/crd/clientset/versioned"
	example "k8s.io2/code-generator/_examples/crd/informers/externalversions/example"
	example2 "k8s.io2/code-generator/_examples/crd/informers/externalversions/example2"
	internalinterfaces "k8s.io2/code-generator/_examples/crd/informers/externalversions/internalinterfaces"
	reflect "reflect"
	sync "sync"
	time "time"
)
