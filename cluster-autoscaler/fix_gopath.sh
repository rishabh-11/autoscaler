...
cp $GOPATH/src/github.com/gardener/autoscaler/cluster-autoscaler/_override/google.golang.org/api/container/v1alpha1/*  $GOPATH/src/google.golang.org/api/container/v1alpha1
cp $GOPATH/src/github.com/gardener/autoscaler/cluster-autoscaler/_override/google.golang.org/api/container/v1beta1/*  $GOPATH/src/google.golang.org/api/container/v1beta1
...
cp $GOPATH/src/github.com/gardener/autoscaler/cluster-autoscaler/_override/github.com/Azure/azure-sdk-for-go/services/mgmt/2017-09-30/containerservice/* $GOPATH/src/github.com/Azure/azure-sdk-for-go/services/mgmt/2017-09-30/containerservice/
